...
{
 var Cmd = ["Service","System", "Main_Zone", "Zone_2", "Zone_3", "Zone_4", "Tuner", "USB", "HD_Radio" , "NET_RADIO" , "SERVER" , "SiriusXM" , "Rhapsody" , "Napster" , "Pandora" , "AirPlay","iPod_USB" , "Spotify"];
...
function ajxHandleSystem(xmlData, rsp, rc)
{
 ...
 val = GCEBTN(xmlData, 'Feature_Existence', 'Napster', '');
 if( val != g_NotExist ){
 g_Info.m_existNapster=true;
 }
 val = GCEBTN(xmlData, 'Feature_Existence', 'SiriusXM', '');
 if( val != g_NotExist ){
 g_Info.m_existSiriusXM=true;
 }
 val = GCEBTN(xmlData, 'Feature_Existence', 'Spotify', '');
 if( val != g_NotExist ){
 g_Info.m_existSpotify=true;
 }
...
function ajxGetNetusbUnitName()
{
 ...
 case "SiriusXM": NetworkUnit = 'SiriusXM'; break;
 case "Rhapsody": NetworkUnit = 'Rhapsody'; break;
 case "Napster": NetworkUnit = 'Napster'; break;
 case "Pandora": NetworkUnit = 'Pandora'; break;
 case "AirPlay": NetworkUnit = 'AirPlay'; break;
 case "Spotify": NetworkUnit = 'Spotify'; break;
 default: break;
 }
 return NetworkUnit;
}
